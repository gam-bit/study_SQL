...
| [15 Days of Learning SQL 2](https://www.hackerrank.com/challenges/15-days-of-learning-sql/problem) | [MS SQL](./HackerRank/15Days_of_Learning_SQL_2.sql) | Hard | ***HackerRank에서 주어진 문제 그대로*** Advanced join; 날짜별로 첫번째 데이터 추출하기; with statement; window function; order by; minimum; rank; where; | ★★★ |
